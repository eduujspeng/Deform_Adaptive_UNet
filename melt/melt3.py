...
# DU-Net + 间隔跳跃
class Melt3(nn.Module):
    def __init__(self, input_channels, num_classes):
        super(Melt3, self).__init__()
    ...
    def forward(self, x):
        ...
        x2_2 = self.conv2_2(
            torch.cat([x2_0, self.up2(x3_1) + self.up_dense1(self.up4(x4_0))], 1))

        x1_3 = self.conv1_3(
            torch.cat([x1_0, self.up2(x2_2) + self.up_dense2(self.up4(x3_1))], 1))

        x0_4 = self.conv0_4(
            torch.cat([x0_0, self.up2(x1_3) + self.up_dense3(self.up4(x2_2))], 1))
